...
const SiteNav = () => {
  ...
  return (
    <>
      <nav
        aria-label="Primary"
        className="fixed top-0 left-0 right-0 z-40 flex items-center justify-between gap-4 border-b border-ink-700/40 bg-ink-900/85 backdrop-blur-[14px] px-6 py-4 md:px-12 lg:px-16 text-moonlight"
      >
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full bg-ochre-500 px-5 py-3 font-mono text-[11px] font-semibold uppercase tracking-[0.14em] text-ink-900 transition-colors hover:bg-ochre-400"
          >
            Donate
