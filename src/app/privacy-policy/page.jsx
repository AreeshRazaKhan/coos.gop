...
const INFORMATION_WE_COLLECT = [
  ...
  },
  {
    ...
    body: 'Records of donations made through third-party payment platforms (Anedot). We do not directly process or store payment card information.',
  },
  {
    label: 'Usage Data',
...
const HOW_WE_USE = [
  'To communicate with you about committee news, events, and volunteer opportunities.',
  ...
  'To improve our website and committee outreach efforts.',
]
          ...
          <div className="mx-auto max-w-[1440px] px-6 py-20 md:px-12 md:py-28 lg:px-16">
            <div className="max-w-[72ch]">
              <p className="text-base md:text-[17px] leading-[1.75] text-ash">
                ...
                website or interact with our committee.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="mt-10 grid grid-cols-1 gap-10 tablet:grid-cols-12">
              ...
              <div className="tablet:col-span-8 flex flex-col gap-6 max-w-[72ch]">
                ...
                <p className="text-base md:text-[17px] leading-[1.7] text-ash">
                  ...
                  law, including campaign finance disclosure requirements.
                </p>
              </div>
            </div>
          </div>
