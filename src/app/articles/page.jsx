          ...
          <div className="mx-auto max-w-[1440px] px-6 py-20 md:px-12 md:py-28 lg:px-16">
            ...
            >
              ...
              <div className="tablet:col-span-5 flex flex-col gap-5 justify-center">
                ...
                <h3
                  className="font-display text-3xl md:text-[40px] font-extrabold leading-[1.05] tracking-[-0.02em] text-ink-900 max-w-[20ch]"
                ...
                <li key={article.id}>
                  ...
                  >
                    ...
                    <div className="flex flex-1 flex-col gap-4 p-7 md:p-8">
                      ...
                      <h3
                        className="font-display text-xl md:text-[24px] font-extrabold leading-[1.15] tracking-[-0.015em] text-ink-900 max-w-[26ch]"
